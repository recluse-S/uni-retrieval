		...
		<div class="table-container">
			...
			<div class="table-cell" style="width: 30%;">
				<div style="display: flex; align-items: center; margin-left: 15%">
					<div> 二级学科 </div>
					<div style="color: blue; font-size: 24px; margin-left: 15%"> 新增 </div>
				</div>
			</div>
			...
			<div class="main-list">
				...
				<ul class="second-category">
					<li v-for="(item, index) in majorSec" :key="index" @click="toggleActive(index, item.id)"
						...
						&nbsp; {{ item.major }}
						<!-- 删除按钮 -->
						<span @click="deleteMajor(index)" class="delete-btn">删除</span>
				...
				<div class="third-category">
					<table>
						<view class="table-row" v-for="(item, index) in majorThi" :key="index"
							...
							<view class="table-cell-2" @click="selectAll3"> 删除 </view>
						</view>
					</table>
				</div>
			</div>
